...
@section('content')
  <div class="max-w-xl mx-auto">
    ...
    <div class="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-slate-200 p-6">
      <div class="mb-5">
        <h2 class="text-lg font-semibold text-slate-900">Edit Kategori</h2>
        <p class="text-sm text-slate-500 mt-1">Perbarui nama atau warna kategori ini.</p>
      </div>

      <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-5" novalidate>
        @csrf
        @method('PUT')
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div class="sm:col-span-1">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="text-xs text-slate-500">Ubah warna kategori.</p>
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-4">
                <div id="chipPreview"
                     ...
                     style="background: {{ old('color', $category->color ?? '#6366f1') }}; color: white;">
