...
@section('content')
  <div class="max-w-5xl mx-auto px-4 py-8">
    ...
    {{-- Flash status (opsional, akan ketemu oleh script toast di layout) --}}
    @if (session('status'))
        ...
        <form action="{{ route('profile.update') }}" method="POST" class="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              class="w-full rounded-lg border-slate-200 focus:border-brand-500 focus:ring-brand-500/40"
        ...
        <form action="{{ route('profile.password') }}" method="POST" class="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              class="w-full rounded-lg border-slate-200 focus:border-slate-800 focus:ring-slate-800/40"
              placeholder="••••••••"
